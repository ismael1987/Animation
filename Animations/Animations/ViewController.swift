...
class ViewController: UIViewController {
  ...
  // MARK: - Variables
   let items = ["2-Color", "Simple 2D Rotation", "Multicolor", "Multi Point Position", "BezierCurve Position","Color and Frame Change", "View Fade In", "Pop"]
  ...
  // Segue when click an a cell we move to the next page
...
extension ViewController: UITableViewDataSource {
  func numberOfSections(in tableView: UITableView) -> Int {
    ...
    // to show how many item in our table
  func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
    return items.count
  }
  
    //to show the item in each cell
